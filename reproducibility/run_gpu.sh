docker run --gpus all -v "$(pwd)"/ann_benchmarks:/home/app/ann_benchmarks:ro -v "$(pwd)"/data:/home/app/data:ro -v "$(pwd)"/results:/home/app/results:rw ann-benchmarks-faissgpu --dataset sift-128-euclidean --algorithm faiss-gpu-bf --module ann_benchmarks.algorithms.faiss_gpu --constructor FaissGPUBF --runs 5 --count 10 --batch [1]
